...
// =================================================================
// Template Name: Muluphee - Nothing is Impossible
// Template Author: Zalindah Team
// Template Author URL: https://muluphee.github.io
// =================================================================
...
var mulupheeTooltip = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
var tooltipList = mulupheeTooltip.map(function (tooltip) {
    return new bootstrap.Tooltip(tooltip);
});

// Toast Activation

var mulupheeToast = [].slice.call(document.querySelectorAll('.toast'));
var toastList = mulupheeToast.map(function (toast) {
